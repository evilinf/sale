...
AmCharts.AmChart = AmCharts.Class({
    ...
    clearLabels: function () {
        ...
        var a = this.product, b = a + "", d = window.location.hostname.split("."), e;
        2 <= d.length && (e = d[d.length - 2] + "." + d[d.length -
            1]);
        AmCharts.remove(this.bbset);
        if (e != b) {
            var b = b + "/?utm_source=swf&utm_medium=demo&utm_campaign=jsDemo" + a, f = "", d = 145;
...
AmCharts.deleteObject = function (a, b) {
    if (a) {
        ...
        if (0 != b)if ("[object Array]" === Object.prototype.toString.call(a))for (var d = 0; d < a.length; d++)AmCharts.deleteObject(a[d], b - 1), a[d] = null; else try {
...
AmCharts.Cuboid = AmCharts.Class({
    construct: function (a, b, d, e, f, g, h, j, k, l, m, n, s) {
        ...
        var b = this.container, d = this.w, e = this.h, f = this.dx, g = this.dy, h = this.colors, j = this.alpha, k =
            this.bwidth, l = this.bcolor, m = this.balpha, n = this.gradientRotation, s = this.cornerRadius, p = h, r = h;
        ...
        if (0 < f || 0 < g)x = r, r = AmCharts.adjustLuminosity(p, -0.2), r = AmCharts.adjustLuminosity(p, -0.2), q = AmCharts.polygon(b, [0, f, d + f, d, 0], [0, g, g, 0, 0], r, j, 0, 0, 0, n), 0 < m && (C = AmCharts.line(b, [0, f, d + f], [0, g, g], l, m, k)), u = AmCharts.polygon(b, [0, 0, d, d, 0], [0, e, e, 0, 0], r, j, 0, 0, 0, 0, n), u.translate(f, g), 0 < m && (t = AmCharts.line(b, [f, f], [g, g + e], l, 1, k)), v = AmCharts.polygon(b,
            [0, 0, f, f, 0], [0, e, e + g, g, 0], r, j, 0, 0, 0, n), w = AmCharts.polygon(b, [d, d, d + f, d + f, d], [0, e, e + g, g, 0], r, j, 0, 0, 0, n), 0 < m && (y = AmCharts.line(b, [d, d + f, d + f, d], [0, g, e + g, e], l, m, k)), r = AmCharts.adjustLuminosity(x, 0.2), x = AmCharts.polygon(b, [0, f, d + f, d, 0], [e, e + g, e + g, e, e], r, j, 0, 0, 0, n), 0 < m && (z = AmCharts.line(b, [0, f, d + f], [e, e + g, e + g], l, m, k));
        1 > Math.abs(e) && (e = 0);
        1 > Math.abs(d) && (d = 0);
...
AmCharts.AmLegend = AmCharts.Class({
    construct: function () {
        ...
        var a = this.position, b = this.marginLeft + this.titleWidth, d = this.marginRight, e = this.marginTop, f = this.marginBottom,
            g = this.horizontalGap, h = this.div, j = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing, n = j - d - b, s = 0, p = 0, r = this.container, q = r.set();
        this.set = q;
        r = r.set();
        q.push(r);
    ...
    construct: function () {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                var r = this.horizontalPadding, n = this.verticalPadding, q = this.pointerWidth, u = this.pointerOrientation, t = this.cornerRadius,
                    v = e.fontFamily, w = this.fontSize;
                ...
                x, v, v, 0, 0, v]), p = AmCharts.polygon(f, l, t, s, this.fillAlpha, this.borderThickness, p, this.borderAlpha));
                g.push(p);
                p.toFront();
                y && y.toFront();
                e.toFront();
...
AmCharts.AmCoordinateChart = AmCharts.Class({
    inherits: AmCharts.AmChart, construct: function () {
        ...
        if (f) {
            var g = !1;
            if (b = this.categoryAxis)var g = b.parseDates, h = b.forceShowField;
            var j, k;
...
AmCharts.TrendLine = AmCharts.Class({
    construct: function () {
        ...
        var a = this;
        a.destroy();
        var b = a.chart, d = b.container, e, f, g, h, j = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, s = a.valueAxis, p = a.valueAxisX, r = a.initialXValue, q = a.finalXValue, u = a.initialValue, t = a.finalValue, v = s.recalculateToPercents;
    ...
    draw: function () {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum))this.fire("logarithmicAxisFailed", {
            ...
            if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs && Infinity != this.min && -Infinity !=
                this.max) {
                var l = this.labelFrequency, m = this.showFirstLabel, n = this.showLastLabel, s = 1, p = 0, r = Math.round((this.max - this.min) / this.step) + 1, q;
                ...
                var t, v = this.guides, w = v.length;
                if (0 < w) {
                    var y = this.fillAlpha;
                    for (e = this.fillAlpha = 0; e < w; e++) {
                        var x = v[e], z = NaN, C = x.above;
                        isNaN(x.toValue) ||
                ...
                for (e = p; e < r; e += s)if (p = this.step * e + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !(this.integersOnly && Math.round(p) != p)) {
                    ...
                    if (p == this.baseValue && "radar" != k) {
                        var G, O, w = this.viW, y = this.viH, p = this.viX;
                        t = this.viY;
        ...
        if (isNaN(a))return NaN;
        var b = this.rotate, d = this.reversed, e = this.axisWidth, f =
            this.stepWidth, g = this.min, h = this.minReal;
...
AmCharts.CategoryAxis = AmCharts.Class({
    inherits: AmCharts.AxisBase, construct: function () {
        ...
        if (AmCharts.ifArray(a)) {
            var b,
                d = this.chart, e = this.start, f = this.labelFrequency, g = 0;
            b = this.end - e + 1;
        ...
        var b = AmCharts.getPeriodDuration(this.periods[a].period, this.periods[a].count), d = Math.ceil(this.timeDifference / b), e = this.periods;
...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, d, e, f, g, h, j, k) {
        ...
        this.set = p;
        var r = a.axisThickness, q = a.axisColor, u = a.axisAlpha, t = a.tickLength, v = a.gridAlpha, w = a.gridThickness, y = a.gridColor, x = a.dashLength, z = a.fillColor, C = a.fillAlpha, I = a.labelsEnabled, G = a.labelRotation, O = a.counter, R = a.inside,
            U = a.dx, T = a.dy, ea = a.orientation, N = a.position, V = a.previousCoord, fa = a.viH, ca = a.viW, da = a.offset, ma, W;
        ...
        W = "start";
        f && (W = "middle");
        var P = G * Math.PI / 180, aa, F = 0, E = 0, A = 0, ga = aa = 0;
        "V" == ea && (G = 0);
        var X;
...
AmCharts.RadAxis = AmCharts.Class({
    construct: function (a) {
        ...
        if (b) {
            ...
            var s = a.length, p;
            for (p = 0; p < s; p++) {
                var r = 180 - 360 / s * p, q = g + this.axisWidth * Math.sin(r / 180 * Math.PI), u = h + this.axisWidth * Math.cos(r /
                        180 * Math.PI);
                0 < f && (q = AmCharts.line(b.container, [g, q], [h, u], e, f, d), this.set.push(q));
                if (k) {
                    var t = "start", q = g + (this.axisWidth + j) * Math.sin(r / 180 * Math.PI), u = h + (this.axisWidth + j) * Math.cos(r / 180 * Math.PI);
...
AmCharts.RadItem = AmCharts.Class({
    construct: function (a, b, d, e, f, g, h) {
        ...
        this.set = e = m.set();
        var n = a.axisColor, s = a.axisAlpha, p = a.tickLength, r = a.gridAlpha, q = a.gridThickness, u = a.gridColor, t = a.dashLength, v = a.fillColor, w = a.fillAlpha, y = a.labelsEnabled;
        f = a.counter;
        var x = a.inside, z = a.gridType, C;
        b -= a.height;
        var I;
        g = a.x;
        var G = a.y;
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createRadarGraph: function () {
        ...
        var a = this.id, b = this.index, d = this.data, e =
        ...
        var P = this.chart.columnSpacing, aa = R.cellWidth, F = (aa * h - n) / n;
        P > F && (P = F);
        ...
        for (L = I; L <= G; L++) {
            ...
            A.index = L;
            var J, K, H, Z, oa = NaN, D = NaN, B = NaN, Q = NaN, M = NaN, Ra = NaN, Ba = NaN, Sa = NaN, Ca = NaN, Y = NaN, ba = NaN, pa = NaN, qa = NaN, S = NaN, Ta = NaN, Ua = NaN, ja = NaN, ka = void 0, va = Bb, Ja = Ga, na = fa, la, ra;
            ...
            if (sa) {
                ...
                var oa = E.x[R.id], wa = Math.floor(aa / 2), Ka = wa;
                        ...
                        if (!isNaN(S)) {
                            ...
                            if (!(S < ob && ja < ob || S > pb && ja > pb))if (m) {
                                ...
                                if (K < k && 0 < H && (ka = new AmCharts.Cuboid(e, Z, H, y, x, va, Ja, N, la, V, W, s,
                                        m), "bottom" != C))if (C = f.reversed ? "left" : "right", 0 > S)C = f.reversed ? "right" : "left"; else if ("regular" == z || "100%" == z)Y += this.dx
                            } else {
                                ...
                                if (J < j + ea * y && 0 < H)if (ka = new AmCharts.Cuboid(e, H, Z, y, x, va, Ja, N, la, this.lineAlpha, W, s, m), 0 > S && "middle" != C)C = "bottom"; else if (C = ma, "regular" ==
                                    z || "100%" == z)ba += this.dy
                            }
                        ...
                        if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(S)) {
                            ...
                            if (m) {
                                if (K = B - h / 2, J = Q, H = h, K + H > k && (H = k - K), 0 > K && (H += K, K = 0), K < k && 0 < H) {
                                    ...
                                    B < k && 0 < B && (Va = AmCharts.line(e, cb, [B, B], la, V, N), bb = AmCharts.line(e, db,
                                        [B, B], la, V, N));
                                    Z = D - Q;
                                    ka = new AmCharts.Cuboid(e, Z, H, y, x, va, Ga, N, la, V, W, s, m)
                                }
                            } else if (J = D - h / 2, K = M + N / 2, H = h, J + H > j && (H = j - J), 0 > J && (H += J, J = 0), Z = B - M, J < j && 0 < H) {
                                var ka = new AmCharts.Cuboid(e, H, Z, y, x, va, Ja, N, la, V, W, s, m), eb, fb;
                    ...
                    case "ohlc":
                        if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(S)) {
                            ...
                            if (m) {
                                ...
                                var lb = D - h / 2, lb = AmCharts.fitToBounds(lb, 0, j), rb = AmCharts.fitToBounds(D,
                                    0, j), mb = D + h / 2, mb = AmCharts.fitToBounds(mb, 0, j);
                        ...
                        if (tb) {
                            ...
                            switch (C) {
                                ...
                                case "right":
                                    ...
                                    break;
                                case "bottom":
                                    m && "column" == g ? (Y = U, 0 > S ? (xa = -6, $.attr({"text-anchor": "end"})) : (xa = 6, $.attr({"text-anchor": "start"}))) : (za = Da / 2 + Xa / 2, $.x = -(Wa / 2 + 2));
                                    break;
                                case "middle":
        ...
        if (1 < a.length) {
            var f = this.set, g = this.container,
                h = g.set(), j = g.set();
            f.push(h);
            f.push(j);
            var k = this.lineAlpha, l = this.lineThickness, m = this.dashLength, f = this.fillAlphas, n = this.fillColors, s = this.negativeLineColor, p = this.negativeFillColors, r = this.negativeFillAlphas, q = this.baseCoord, u = AmCharts.line(g, a, b, this.lineColor, k, l, m, !1, !0);
            h.push(u);
    ...
    drawSmoothedGraph: function (a, b, d, e) {
        if (1 < a.length) {
            ...
            f.push(h);
            f.push(j);
            var k = this.lineAlpha, l = this.lineThickness, f = this.dashLength, m = this.fillAlphas, n = this.fillColors, s = this.negativeLineColor, p = this.negativeFillColors, r = this.negativeFillAlphas, q = this.baseCoord, u = new AmCharts.Bezier(g, a, b, this.lineColor, k, l, n, 0, f);
            h.push(u.path);
        ...
        if (0 < b && !a.animationPlayed) {
            ...
            AmCharts.VML ||
            (d.attr({opacity: a.startAlpha}), e.attr({opacity: a.startAlpha}));
            d.hide();
            e.hide();
        ...
        if ("none" != this.bullet || a.bullet) {
            ...
            f = this.bullet;
            a.bullet && (f = a.bullet);
            var h = this.bulletBorderThickness, l = this.bulletBorderColor, m = this.bulletBorderAlpha, n = k, s = this.bulletAlpha, k = a.alpha;
            isNaN(k) || (s = k);
            k = 0;
            switch (f) {
                case "round":
...
AmCharts.ChartCursor = AmCharts.Class({
    construct: function () {
        ...
        var a = this.chart, b = this.cursorAlpha, d = a.categoryAxis,
            e = d.position, f = d.inside, g = d.axisThickness, h = this.categoryBalloon, j, k, l = a.dx, m = a.dy, n = this.x, s = this.y, p = this.width, r = this.height, a = a.rotate, q = d.tickLength;
        h.pointerWidth = q;
        ...
        if (this.enabled) {
            void 0 === b && (b = !0);
            this.index = a;
            var g = d.categoryAxis, h = d.dx, j = d.dy, k = this.x, l = this.y, m = this.width, n = this.height, s = this.data[a];
            if (s) {
                var p = s.x[g.id], r = d.rotate, q = g.inside, u = this.stepWidth,
                    t = this.categoryBalloon, v = this.firstTime, w = this.lastTime, y = this.cursorPosition, x = g.position, z = this.zooming, C = this.panning, I = d.graphs, G = g.axisThickness;
                if (d.mouseIsOver || z || C || this.forceShow)if (this.forceShow = !1, C) {
                    var h = this.panClickPos, d = this.panClickEndTime, z = this.panClickStartTime, O = this.panClickEnd, k = this.panClickStart, e = (r ? h - f : h - e) / u;
                    ...
                    b ? (h = {type: "changed"}, h.index = a, h.target = this, h.chart = this.chart, h.zooming = z, h.mostCloseGraph = O, h.position = r ? f : e, h.target = this, d.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, d.updateLegendValues(a));
        ...
        if (a) {
            var e = a.mouseX - this.x, f = a.mouseY -
                this.y;
            if (this.drawingNow) {
                this.drawingNow = !1;
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({
    construct: function () {
        ...
        d = j.x + f;
        e = j.y + g;
        var k = j.width, j = j.height, l = this.rotate, m = this.chart, n = this.width, s = this.height, p = m.mouseX, r = m.mouseY;
        a = this.initialMouse;
    ...
    inherits: AmCharts.SimpleChartScrollbar, construct: function () {
        ...
        if (l = a.graph) {
            ...
            for (p = 0; p < d.length; p++) {
                var r = d[p].axes[s.id].graphs[l.id].values, q;
...
AmCharts.wedge = function (a, b, d, e, f, g, h, j, k, l, m) {
    ...
    h = n(h);
    j = n(j);
    var s = n(h / g * j), p = AmCharts.VML, r = -359.5 - g / 100;
    -359.95 > r && (r = -359.95);
    f <= r && (f = r);
    var q = 1 / 180 * Math.PI, r = b + Math.cos(e * q) * j, u = d + Math.sin(-e * q) * s, t = b + Math.cos(e * q) * g, v = d + Math.sin(-e * q) * h, w = b + Math.cos((e + f) * q) * g, y = d + Math.sin((-e - f) * q) * h, x = b + Math.cos((e + f) * q) * j, q = d + Math.sin((-e - f) * q) * s, z = {
    ...
    inherits: AmCharts.AmChart, construct: function () {
        ...
        if (AmCharts.ifArray(b)) {
            if (0 < a.realWidth && 0 < a.realHeight) {
                ...
                a.chartDataLabels = [];
                a.ticks = [];
                var n, s, p, r = AmCharts.toNumber(a.labelRadius), q = a.measureMaxLabel();
                ...
                for (m = 0; m < b.length; m++)if (f = b[m], !0 !== f.hidden && 0 < f.percents) {
                    var k = 360 * -f.percents / 100, q = Math.cos((g + k / 2) / 180 * Math.PI), u = Math.sin((-g - k / 2) / 180 * Math.PI) * (l / p), j = {
                        fill: f.color,
        ...
        for (b = 0; b < a.length; b++)if (this.chartDataLabels[b]) {
            var d = a[b], e = d.ty, f = this.radiusReal, e = AmCharts.line(this.container, [this.pieXReal + d.ix * f, d.tx, d.tx2], [this.pieYReal + d.iy * f, e, e], this.labelTickColor, this.labelTickAlpha);
            d.wedge.push(e);
            this.ticks[b] = e
        }
...
AmCharts.AmXYChart = AmCharts.Class({
    inherits: AmCharts.AmRectangularChart, construct: function () {
        ...
        var b = this.widthMultiplier * this.plotAreaWidth / a.selectionWidth, d = this.heightMultiplier * this.plotAreaHeight / a.selectionHeight, b = this.fitMultiplier(b),
...
AmCharts.VMLRenderer = AmCharts.Class({
    construct: function (a) {
        ...
        if (0 != Number(b)) {
            ...
            e.paddingLeft =
                1;
            var f = b * Math.PI / 180, g = Math.cos(f), h = Math.sin(f), j = AmCharts.removePx(e.left), k = AmCharts.removePx(e.top), l = d.offsetWidth, d = d.offsetHeight, m = b / Math.abs(b);
